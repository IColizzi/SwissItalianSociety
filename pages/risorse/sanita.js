  ...
  return (
    <>
      ...
      <p1>
        ...
        italiana che è valida anche in svizzera per max 5 anni. Per questo devi
        cheidere un esenzione al cantone di zurigo e rinnovarla dopo 3 anni. Il
        sito per chiederla in uno dei due siti:
        ...
        diversa. La lista di assicuarazioni per studenti che hanno
        l&apos;esenzione è qui:
      ...
      <p1>
        ...
        In Svizzera non è comune andare al pronto soccorso come in Italia, ed è
        consigliato recarvicisi solo in casi di emergenza e di andare
      ...
      <p1>
        ...
        scritto quanto devi pagare. Dopo averlo fatto devi mandare una foto del
        pagamento e della lettera alla tua assicurazione per studenti (se ne hai
        una) oppure a https://www.kvg.org/en/ (per email a: info@kvg.org). Il
        rimborso sarà uguale al totale speso a meno di 92 CHF, ogni 30 giorni
        (ex: facendo 2 altre visite nei 30 giorni successivi alla prima visita,
        si pagheranno in totale 92 CHF).
      </p1>
