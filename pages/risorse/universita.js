  ...
  return (
    <>
      <StyledPage>
        ...
        all&apos;ammissione universitaria. Se ti sei gia’ iscritto torverai
        tutte le informazioni riguardati lo studio e non solo qu questa pagina:
        (add link to page uni)
        <h3>ETH</h3>
        ...
        <p1>
          ...
          Infatti, devi:
          <br />- avere un certificato C1 di tedesco (il migliore è il DAF
          perchè basta avere il livello 4 che in realtà è B2-C1 e quindi un
          pochino piu&apos; semplice da passare ed e piu&apos; economico
          rispetto al Goethe). Stai attento/a perchè non ci sono tanti slots
          all&apos;anno e devi avere un margine nel caso tu debba rifare
          l&apos;esame…
          <br />- avere il certificato di maturità prima di aver concluso la
          maturità (basta un foglio scritto dalla tua scuola - di solito hai già
          i voti degli scritti + i tuoi crediti e riesci ad avere 60 prima di
          aver fatto l&apos;orale ..)
          <br />- se hai fatto una scuola diversa dal liceo scientifico devi
          fare anche un esame di ingresso all&apos;ETH. L&apos;esame è
          praticamente una seconda maturità in tedesco sulle seguenti materie:
          chimica, fisica, biologia e matematica - orale e scritto:
          ...
          scientifico… pero&apos; se hai voglia di rendere la tua vita
          complicata contattaci che l&apos;ho fatto anche io :)
          <br />
          <br />
        ...
        <p1>
          ...
          pronto prima della scandeza dei termini per l&apos;ammissione.
          Considerando che i risultati di questi test arrivano ogni 3 mesi,
          meglio organizzarsi con largo anticipo in caso non lo si superi al
          primo tentativo.
          ...
          però necessario però che voi indicate il nome sul portale di
          ammissione entro la data di scadenza. A voi verrà notificato se la
          lettera del professore è stata ricevuta dall&apos; ETH o meno ma non
          vi verrà fatto sapere il suo contenuto, (a meno che il Prof non ve
          l&apos;abbia mandata privatamente).
          ...
          ad entrare all&apos;ETH. Si tratta, forse, del documento più
          importante insieme al Transcript of Records.
          <br />- Curriculum Vitae
        </p1>{" "}
        <br />
