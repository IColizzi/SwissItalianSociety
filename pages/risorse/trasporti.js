  ...
  return (
    <>
      <StyledPage>
        ...
        <p1>
          {" "}
          Prima cosa da fare è scaricare l&apos;app dell&apos;SBB. Google maps
          non e&apos; sempre aggiornato! Con l&apos;app puoi pianificare viaggi,
          comprare biglietti, usare easy ride (un opzione che ti permette di non
          dover comprare piu&apos; nessun biglietto, semplicemente attivala
          prima di partire e fermala quando sei arrivato, l&apos;app calcolerà
        ...
        <p1>
          ...
          telefonico della Sunrise costa la metà.
          <br /> - GA: abbonamento generale che ti permette di viaggiare in
          tutta la svizzera senza comprare il biglietto. E&apos; un po&apos;
          caro ...
        </p1>
        ...
        <p1>
          ...
          sono leggende che dicono che hai solo un anno per farlo. Non è vero.
