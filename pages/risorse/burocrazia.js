  ...
  return (
    <>
      ...
      <p1>
        ...
        importa se sei in affitto o da un amico che ti ospita, la prima cosa da
        fare è andare al Kreisbüro. Porta con te il documento di identità
        ...
        indirizzo come tuo recapito. Il prezzo per il permesso di soggiorno è di
        85 CHF e ti verrà mandato per posta entro 10 giorni; nel frattempo ti
        rilasceranno un foglio ufficiale con il quale potrai aprire il conto in
        banca e chiedere un numero di telefono svizzero.
      </p1>
      ...
      <p1>
        ...
        svizzera. Sul sito dell&apos;aire si legge: “I cittadini che
        trasferiscono la propria residenza all&apos;estero per periodi superiori
        a 12 mesi consecutivi; la dichiarazione deve essere presentata entro 90
        giorni dall&apos;espatrio definitivo ed è possibile richiederla anche
      ...
      <p1>
        ...
        possono esercitare il diritto di voto all&apos;estero nel luogo di
        residenza per le elezioni dei membri della Camera e del Senato, per i
        referendum abrogativi e costituzionali di cui agli artt. 75 e 138 della
        Costituzione e per le elezioni dei membri del Parlamento europeo
        spettanti all&apos;Italia. Ove costituiti, i cittadini possono
        partecipare anche all&apos;elezione dei Comitati degli italiani
        residenti all&apos;estero (COMITES). Il voto all&apos;estero non è
        invece previsto per l&apos;elezione dei Consigli regionali, comunali e
        provinciali, né per i referendum locali. (Fonte:
