  ...
  return (
    <>
      ...
      <p1>
        ...
        andare alla coop che è cara. Non avere avere paura dei discount, Lidl è
        tuo amica, cosi&apos; come Denner. La migros ha anche prodotti economici
        in relatà. SPAR invece non ho proprio capito perchè esiste… <br />
        Anche qui funziona
      ...
      <p1>
        ...
        altissime. La cosa migliore è fare aquisti in italia, oppure se proprio
        vuoi usa galaxus. <Link href="https://galaxus.ch/en"> Galaxus </Link> e’
        davvero geniale perche’ il pacchetto ti arriva il giorno stesso…
      </p1>
      <h3>Second Hand</h3>
      <p1>
        In svizzera il second hand è praxis. Qui la gente va e viene e lascia
        spesso cio’ che ha comprato a disposizione dei prossimi. Non parlo solo
        di mobili ma anche di vestiti, piante, sci, monitors… diciamo tutto. Ci
        sono diverse piattaforme online ma a volte trovi dei pacchetti anche per
        strada con scritto “free to take”!
        <br /> Qui aluni siti interessanti:
        <br />- <Link href="https://tutti.ch/de"> Tutti.ch</Link>
        <br />- <Link href="https://ricardo.ch/ "> Ricardo</Link>
        <br /> Se cerchi vestiti ci sono tanti negozietti in centro oppure puoi
        guardare online su siti tipo
      ...
      <p1>
        ...
        comprare quelli disponibili su galaxus. Stai atteno che puoi pagare una
        multa fino a 700chf altreimenti …
      </p1>
      <h3>Come imparare il tedesco...serve?</h3>
      <p1>
        In realtà se vieni per il master puoi sopravvivere senza, anche perchè a
        zurigo non si parla tedesco ma dialetto… Se vuoi e devi impararlo ci
        ...
        <br />- Tandem partner (c&apos;è anche una mobile app per questo) - free
