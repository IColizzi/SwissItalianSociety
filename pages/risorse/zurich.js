  ...
  return (
    <>
      <StyledPage>
        ...
        <p1>
          Ricordati che domenica e’ tutto chiuso! Non andare alla coop che e’
          cara. Non avere avere paura dei discount, Lidl e’ tuo amico, cosi’
          come Denner. La migros ha anche prodotti economici in relata’. SPAR
          invece non ho proprio capito perche’ esiste… <br />
          Anche qui funziona
        ...
        <p1>
          Non comprare cose su amazon perche’ hai dei prezzi di spedizione
          altissime. La cosa migliore e’ fare aquisti in italia, oppure se
        ...
        <h3>Second Hand</h3>
        <p1>
          In svizzera il second hand e’ praxis. Qui la gente va e viene e lascia
          ...
          <br />
          All’ETH ci sono 2 eventi all’anno, uno in inverno e uno in estate dove
          rivendono o vendono materiale sportivo a basso prezzo.
        </p1>
        ...
        <p1>
          In realta’ se vieni per il master puoi sopravvivere senza, anche
          perche’ a zurigo non si parla tedesco ma dialetto… Se vuoi e devi
          impararlo ci sono un po’ di possibita’
          <br />- Sprachzentrum ETH - 80chf a semestre
          <br />- Sprachzentrum Clubschule Migros
          <br />- Sprachzentrum Kanton Zurich
          <br />- Tandem partner (c’e’ anche una mobile app per questo) - free
